    ...
    Modernizr.load([
		{
		    load: [
                ...
                'preload!scripts/Books.js',
				'preload!scripts/Screens.js', //requires Books.js
				'preload!scripts/ScreenManager.js', //requires Screens.js
                //'preload!scripts/Blocks.js',
                'preload!scripts/GameCore.js',
                ...
                'preload!scripts/KeyBoard.js', //requires GameCore.js
                'preload!scripts/GameLoop.js', //requires GameCore.js
